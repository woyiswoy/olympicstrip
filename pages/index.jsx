            ...
            <div className='w-full bg-black min-h-[80vh]'>
              <div className='max-w-6xl mx-auto flex flex-col justify-center px-10 py-20 gap-4'>
                ...
                <Paragraph
                  className={'text-base md:text-lg lg:text-xl text-white'}
                >
                  สัญลักษณ์โอลิมปิก (Olympic Symbols) เป็นรูปวงกลม 5
                  ห่วงคล้องกันอยู่ 2 ชั้น ชั้นบนมีอยู่ 3 ห่วง ชั้นล่าง 2 ห่วง
                  ประกอบด้วย สีน้ำเงิน สีเหลือง สีดำ สีเขียวและสีแดง ตั้งอยู่บน
                  พื้นขาว ผู้ออกแบบสัญลักษณ์นี้ก็คือ คูเบอร์-แตง "บิดาแห่ง
                  กีฬาโอลิมปิก"
                </Paragraph>
                <Paragraph
                  className={'text-base md:text-lg lg:text-xl text-white'}
